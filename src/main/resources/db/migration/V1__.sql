...
CREATE TABLE member
    ...
    (
        255
    ) NOT NULL, provider VARCHAR(255) NOT NULL, provider_id VARCHAR(255) NULL, created_at datetime NOT NULL, updated_at datetime NOT NULL, url VARCHAR(255) NULL, CONSTRAINT pk_member PRIMARY KEY (id) );
...
CREATE TABLE perfume
    ...
    (
        5000
    ) NULL, release_year INT NULL, brand_id BIGINT NOT NULL, concentration VARCHAR(255) NULL, is_approved BIT(1) NOT NULL, creator_id BIGINT NULL, url VARCHAR(255) NULL, CONSTRAINT pk_perfume PRIMARY KEY (id) );
...
CREATE TABLE perfume_designer
    ...
    (
        255
    ) NOT NULL, `description` VARCHAR(255)          NULL, CONSTRAINT pk_perfume_designer PRIMARY KEY (id) );
