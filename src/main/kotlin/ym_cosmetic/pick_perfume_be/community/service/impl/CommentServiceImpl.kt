...
class CommentServiceImpl(
    ...
    override fun createComment(postId: Long, request: CommentCreateRequest, member: Member): Long {
    ...
    @Transactional(readOnly = true)
    override fun getCommentRepliesByParentId(
        parentId: Long,
        pageable: Pageable,
        currentMember: Member?
    ): PageResponse<CommentResponse> {
    ...
    override fun deleteComment(commentId: Long, member: Member): Long {
        val comment = commentRepository.findByIdAndIsDeletedFalse(commentId)
            .orElseThrow { EntityNotFoundException("댓글을 찾을 수 없습니다.") }
    ...
    override fun likeComment(commentId: Long, member: Member): Long {
        val comment = commentRepository.findByIdAndIsDeletedFalse(commentId)
            .orElseThrow { EntityNotFoundException("댓글을 찾을 수 없습니다.") }
    ...
    override fun unlikeComment(commentId: Long, member: Member): Long {
